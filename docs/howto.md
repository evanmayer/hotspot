...
![Stepper Wiring Example](img/stepper_wiring.jpg)
...
## `pdoc`
The html documentation is generated by [pdoc](https://pdoc.dev/docs/pdoc.html).
...
![Test bench setup](img/spool_side_view.jpg "Test bench setup") ![Test bench setup](img/spool_bench_mounted.jpg)
