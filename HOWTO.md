...
## `pdoc`
The html documentation of the source code is generated by [portray](https://timothycrosley.github.io/portray/).

To regenerate the documentation, execute:

``` bash
portrary portray as_html -m hotspot -o docs/html/ --overwrite
```
